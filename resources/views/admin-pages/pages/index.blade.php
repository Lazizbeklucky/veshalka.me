@extends('admin-pages.layouts.admin-layout')
@section('content')
<aside class="left-sidebar">
    ...
    <nav class="left-nav">
        <ul id="nav">
            ...
            <li>
                <a href="#css-structure">CSS Files</a>
            </li>
            <li>
            ...
            <li>
                <a href="#colors">Change Theme Color</a>
            </li>
            <li>
    ...
    <div class="main-content">
        <section id="welcome">
            <div class="content-header">
                <h1>Eshop - eCommerce HTML5 Template.</h1>
            </div>
            <div class="welcome">

                <h2 class="twenty">Welcome To Eshop - eCommerce HTML5 Template.</h2>
                ...
                <p>This document covers the installation and use of this theme and often reveals answers to common problems and issues
                    ...
                    <code>
                        <a href="mailto:wpthemesgrid@gmail.com">wpthemesgrid@gmail.com</a>
                    </code> Thank you so much!</p>
            </div>
            ...
            <div class="features">
                ...
                <ul>
                    ...
                    <li>HTML5 &amp; CSS3</li>
                    <li>Bootstrap 4.0</li>
                    <li>Awesome Color Plate With 12 Colors</li>
                    <li>19+ Html Pages</li>
            ...
            <div class="section-content">
                <ol>
                    ...
                    <li>Now go to your cpanel or open your FTP Client (like
                        <a target="_blank" href="https://filezilla-project.org/download.php">Filezilla</a>) and upload the content of the Template on your server root.</li>
        ...
        <section id="tmpl-structure">
            ...
            <p class="fifteen">All information within the main content area is nested within a body tag. The general template structure is pretty the
        ...
        <section id="css-structure">
            ...
            <p class="fifteen">These are the css files that are loaded into templates in
            ...
            <p>By default, the template loads this font from Google Web Font Services, you can change the font with the one that suits
                you best.</p>
        ...
        <section id="contact-form">
            ...
            <p>This is a PHP Script for sending messages to your email, you should replace
                <strong>youremail@gmail.com</strong> to your email to start receive messages.</p>
            <pre class="brush:php">
						if($_POST) {
