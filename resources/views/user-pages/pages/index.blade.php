...
@section('content')
    ...
    <section class="hero-slider">
        <!-- Single Slider -->
        <div class="single-slider" style="background-image: url('/assets/images/1900.jpg') !important;">
            <div class="container">
                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#man"
                                                        role="tab">Man</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#women" role="tab">Woman</a>
                                </li>
                                ...
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#prices" role="tab">Prices</a>
                                </li>
                            </ul>
                            <!--/ End Tab Nav -->
                        </div>
                        <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img class="default-img" src="/assets/images/550.png" alt="#">
                                                        <img class="hover-img" src="/assets/images/550.jpg" alt="#">
                                                    </a>
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img class="default-img" src="/assets/images/550.jpg" alt="#">
                                                        <img class="hover-img" src="/assets/images/550.jpg" alt="#">
                                                    </a>
                                                    <div class="button-head">
                                                        <div class="product-action">
                            ...
                            <div class="tab-pane fade" id="essential" role="tabpanel">
                                @component('user-pages.components.product')
                                @endcomponent
                            </div>
                            <!--/ End Single Tab -->
                            <!-- Start Single Tab -->
